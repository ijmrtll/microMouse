...
void set_speeds(double v , double w) {
  ...
  vel_r_new = map(vel_r_new, 0, max_vel*10, 120, 255);
  vel_l_new = map(vel_l_new, 0, max_vel*10, 130, 255);

  vel_r_new = constrain(vel_r_new, 120, 255);
  vel_l_new = constrain(vel_l_new, 130, 255);
